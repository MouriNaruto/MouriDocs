# Start using Alpine Linux as my daily Linux distro

> [!NOTE]
> This document will be kept for historic purpose.
...
things need to be cautious. I will write some notes for using Alpine Linux.
